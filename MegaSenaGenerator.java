...
public class MegaSenaGenerator {
    ...
    public static void main(String[] args) {
        ...
        addResult(new HashSet<>(Arrays.asList(5, 12, 18, 23, 32, 44)));   // Contest 2700 - 05/03/2025
        addResult(new HashSet<>(Arrays.asList(7, 14, 21, 28, 35, 42)));  // Contest 2699 - 02/03/2025
        addResult(new HashSet<>(Arrays.asList(3, 9, 15, 22, 29, 36)));   // Contest 2698 - 28/02/2025
        addResult(new HashSet<>(Arrays.asList(8, 16, 24, 32, 40, 48)));  // Contest 2697 - 25/02/2025
        addResult(new HashSet<>(Arrays.asList(1, 11, 19, 27, 35, 43)));  // Contest 2696 - 22/02/2025
